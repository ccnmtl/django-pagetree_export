...
def register(block_class, identifier,
    ...
    if export_fn:
        _pageblock_exporters.setdefault(export_type, {})[block_class] = \
            (identifier, export_fn)
    if import_fn:
        _pageblock_importers.setdefault(export_type, {})[identifier] = \
            import_fn
...
def register_class(cls):
    ...
    register(block_class, identifier, export_fn, import_fn,
             override=False, export_type=export_type)
    return cls
